 ...
 * 
 */
@WebServiceClient(name = "UsersWS", targetNamespace = "http://serve/", wsdlLocation = "http://localhost:8080/ShareBooksServer/UsersWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSWS_QNAME = new QName("http://serve/", "UsersWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ShareBooksServer/UsersWS?wsdl");
    ...
    public UsersWS getUsersWSPort() {
        return super.getPort(new QName("http://serve/", "UsersWSPort"), UsersWS.class);
    }
    ...
    public UsersWS getUsersWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serve/", "UsersWSPort"), UsersWS.class, features);
    }
