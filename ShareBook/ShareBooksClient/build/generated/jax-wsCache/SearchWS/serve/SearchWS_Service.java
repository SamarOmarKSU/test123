 ...
 * 
 */
@WebServiceClient(name = "SearchWS", targetNamespace = "http://serve/", wsdlLocation = "http://localhost:8080/ShareBooksServer/SearchWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SEARCHWS_QNAME = new QName("http://serve/", "SearchWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ShareBooksServer/SearchWS?wsdl");
    ...
    public SearchWS getSearchWSPort() {
        return super.getPort(new QName("http://serve/", "SearchWSPort"), SearchWS.class);
    }
    ...
    public SearchWS getSearchWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serve/", "SearchWSPort"), SearchWS.class, features);
    }
